...
export interface IPosPrinterPlugin {
     ...
     */
    getPrinterStatus(success: () => PrinterStatus, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printerInit(success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    setPrinterPrintDepth(depth: number, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    setPrinterPrintFontType(typeface: string, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    setPrinterPrintFontSize(fontsize: number, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    setPrinterPrintAlignment(alignment: number, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printerFeedLines(lines: number, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printBlankLines(lines: number, height: number, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printText(text: string, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printSpecifiedTypeText(text: string, typeface: string, fontsize: number, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printSpecFormatText(text: string, typeface: string, fontsize: number, alignment: number, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printColumnsText(colsTextArr: string[], colsWidthArr: number[], colsAlign: number[], isContinuousPrint: number, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printBitmap(alignment: number, bitmapSize: number, mBitmap: number[] | string[], success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printBarCode(data: string, symbology: number, height: number, width: number, textposition: number, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printQRCode(data: string, modulesize: number, mErrorCorrectionLevel: number, success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printRawData(rawPrintData: number[] | string[], success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    sendUserCMDData(data: number[] | string[], success: () => string, error: (value: string) => void);
     ...
     * @param {function} error
     */
    printerPerformPrint(feedlines: number, success: () => string, error: (value: string) => void);
}
